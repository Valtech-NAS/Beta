    ...
    public class ApplicationStatusSummaryMapper : MapperEngine
    {
        public override void Initialise()
        {
            Mapper.CreateMap<CandidateApplication, Domain.Entities.Applications.ApplicationStatusSummary>()
                ...
                .ForMember(x => x.ApplicationStatus, opt => opt.ResolveUsing<ApplicationStatusResolver>()
                    .FromMember(src => src.ApplicationStatus))
                .ForMember(x => x.VacancyStatus, opt => opt.ResolveUsing<VacancyStatusResolver>()
                    .FromMember(src => src.VacancyStatus))
