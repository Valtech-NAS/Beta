namespace SFA.Apprenticeships.Web.Candidate.Constants.ViewModels
{
    ...
    public static class AddressMessages
    {
        public static class AddressLine1
        {
            ...
            public const string TooLongErrorText = "'First line of address' must not exceed 50 characters";
        ...
        public static class AddressLine2
        {
            ...
            public const string TooLongErrorText = "'Second line of address' must not exceed 50 characters";
            public const string WhiteListRegularExpression = Whitelists.FreetextWhitelist.RegularExpression;
        ...
        public static class AddressLine3
        {
            ...
            public const string TooLongErrorText = "'Town or city' must not exceed 50 characters";
            public const string WhiteListRegularExpression = Whitelists.FreetextWhitelist.RegularExpression;
        ...
        public static class AddressLine4
        {
            ...
            public const string TooLongErrorText = "'County' must not exceed 50 characters";
            public const string WhiteListRegularExpression = Whitelists.FreetextWhitelist.RegularExpression;
