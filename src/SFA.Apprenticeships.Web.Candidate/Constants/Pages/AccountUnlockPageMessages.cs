namespace SFA.Apprenticeships.Web.Candidate.Constants.Pages
{
    ...
    {
        public const string AccountUnlockFailed = "TODO: There has been an error unlocking your account. Please try again.";
        public const string AccountUnlockCodeExpired = "TODO: Account unlock code has expired, new account unlock code has been sent.";
