namespace SFA.Apprenticeships.Web.Candidate.Constants.Pages
{
    ...
    public static class AccountUnlockPageMessages
    {
        ...
        public const string WrongEmailAddressOrAccountUnlockCodeErrorText = "TODO: Please enter a valid email address or unlock code. Check your email to make sure you’ve got the correct one.";
