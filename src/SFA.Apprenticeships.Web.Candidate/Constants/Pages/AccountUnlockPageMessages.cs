namespace SFA.Apprenticeships.Web.Candidate.Constants.Pages
{
    ...
    public static class AccountUnlockPageMessages
    {
        ...
        public const string AccountUnlockCodeMayHaveBeenResent = "Please check your email for an account unlock code. If you do not receive one, please check you have entered your email correctly and that your account is locked.";
