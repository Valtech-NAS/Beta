namespace SFA.Apprenticeships.Web.Candidate.Constants.Pages
{
    ...
    public static class ActivationPageMessages
    {
        ...
        public const string AccountActivated = "You've successfully activated your account <script>Webtrends.multiTrack({ element: this, argsa: ['DCS.dcsuri', '/register/activation/complete', 'WT.dl', '0', 'WT.ti', 'Activation Complete'] });</script>";
