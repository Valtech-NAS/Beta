...
<head>
    ...
    <!--[if gt IE 8]><!--><link href="//az693485.vo.msecnd.net/prod/css/main.css" rel="stylesheet" /><!--<![endif]-->
    <!--[if lte IE 8]><link href="//az693485.vo.msecnd.net/prod/css/main-ie8.css" rel="stylesheet" /><![endif]-->
    <!--[if lte IE 8]><link href="//az693485.vo.msecnd.net/prod/css/fonts-ie8.css" rel="stylesheet" /><![endif]-->
    <!--[if gte IE 9]><!--><link href="//az693485.vo.msecnd.net/prod/css/fonts.css" rel="stylesheet" /><!--<![endif]-->
    <link rel="shortcut icon" href="//az693485.vo.msecnd.net/prod/img/favicon.ico" type="image/x-icon">
    <link href="//az693485.vo.msecnd.net/prod/css/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
        ...
        <div class="global-header__wrapper">
            <div class="global-header__logo">
                <a href="http://gov.uk" title="Go to the GOV.UK homepage" class="govuk-logo">
                    <img src="//az693485.vo.msecnd.net/prod/gov.uk_logotype_crown.png" alt="Crown">
                GOV.UK
                </a>
            </div>
        ...
        <div class="footer__wrapper">
            <div class="footer__meta">
                ...
                <a class="footer__copyright" href="http://www.nationalarchives.gov.uk/information-management/our-services/crown-copyright.htm" target="_blank">
                    <img src="//az693485.vo.msecnd.net/prod/govuk-crest-2x.png" width="125" height="102" alt="Crown copyright logo">
