...
WriteAttribute("class", Tuple.Create(" class=\'", 35), Tuple.Create("\'", 156)
            
            #line 3 "..\..\Views\Shared\ValidationSummary.cshtml"
, Tuple.Create(Tuple.Create("", 43), Tuple.Create<System.Object, System.Int32>(Html.ViewData.ModelState.IsValid ? "validation-summary-valid" : "validation-summary-errors"
            
            #line default
            #line hidden
, 43), false)
, Tuple.Create(Tuple.Create(" ", 137), Tuple.Create("panel", 138), true)
, Tuple.Create(Tuple.Create(" ", 143), Tuple.Create("panel-danger", 144), true)
);
...
WriteAttribute("href", Tuple.Create(" href=\"", 751), Tuple.Create("\"", 782)
, Tuple.Create(Tuple.Create("", 758), Tuple.Create("#", 758), true)
            
            #line 18 "..\..\Views\Shared\ValidationSummary.cshtml"
, Tuple.Create(Tuple.Create("", 759), Tuple.Create<System.Object, System.Int32>(@elementId.ToLower()
