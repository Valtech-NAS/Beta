...
WriteAttribute("href", Tuple.Create(" href=\"", 13068), Tuple.Create("\"", 13144)
            
            #line 227 "..\..\Views\Account\Index.cshtml"
                , Tuple.Create(Tuple.Create("", 13075), Tuple.Create<System.Object, System.Int32>(Url.Action("Archive", "Account", new { id = application.VacancyId })
...
WriteAttribute("href", Tuple.Create(" href=\"", 18406), Tuple.Create("\"", 18481)
            
            #line 316 "..\..\Views\Account\Index.cshtml"
, Tuple.Create(Tuple.Create("", 18413), Tuple.Create<System.Object, System.Int32>(Url.Action("Delete", "Account", new { id = application.VacancyId })
