...
WriteAttribute("href", Tuple.Create(" href=\"", 1375), Tuple.Create("\"", 1468)
            
            #line 29 "..\..\Views\ApprenticeshipApplication\Apply.cshtml"
, Tuple.Create(Tuple.Create("", 1382), Tuple.Create<System.Object, System.Int32>(Url.RouteUrl(CandidateRouteNames.ApprenticeshipDetails, new { id = Model.VacancyId })
...
WriteAttribute("onclick", Tuple.Create(" onclick=\'", 2662), Tuple.Create("\'", 2847)
, Tuple.Create(Tuple.Create("", 2672), Tuple.Create("Webtrends.multiTrack({", 2672), true)
, Tuple.Create(Tuple.Create(" ", 2694), Tuple.Create("element:", 2695), true)
, Tuple.Create(Tuple.Create(" ", 2703), Tuple.Create("this,", 2704), true)
, Tuple.Create(Tuple.Create(" ", 2709), Tuple.Create("argsa:", 2710), true)
, Tuple.Create(Tuple.Create(" ", 2716), Tuple.Create("[\"DCS.dcsuri\",", 2717), true)
, Tuple.Create(Tuple.Create(" ", 2731), Tuple.Create("\"/apprenticeship/apply/savedraft/", 2732), true)
            
            #line 58 "..\..\Views\ApprenticeshipApplication\Apply.cshtml"
                                                                                                                                                                       , Tuple.Create(Tuple.Create("", 2765), Tuple.Create<System.Object, System.Int32>(Model.VacancyId
            
            #line default
            #line hidden
, 2765), false)
, Tuple.Create(Tuple.Create("", 2781), Tuple.Create("\",", 2781), true)
, Tuple.Create(Tuple.Create(" ", 2783), Tuple.Create("\"WT.dl\",", 2784), true)
, Tuple.Create(Tuple.Create(" ", 2792), Tuple.Create("\"99\",", 2793), true)
, Tuple.Create(Tuple.Create(" ", 2798), Tuple.Create("\"WT.ti\",", 2799), true)
, Tuple.Create(Tuple.Create(" ", 2807), Tuple.Create("\"Apprenticeship", 2808), true)
, Tuple.Create(Tuple.Create(" ", 2823), Tuple.Create("–", 2824), true)
, Tuple.Create(Tuple.Create(" ", 2825), Tuple.Create("Save", 2826), true)
, Tuple.Create(Tuple.Create(" ", 2830), Tuple.Create("Draft", 2831), true)
, Tuple.Create(Tuple.Create(" ", 2836), Tuple.Create("Form\"]", 2837), true)
...
WriteAttribute("href", Tuple.Create(" href=\"", 3070), Tuple.Create("\"", 3126)
            
            #line 62 "..\..\Views\ApprenticeshipApplication\Apply.cshtml"
                                                            , Tuple.Create(Tuple.Create("", 3077), Tuple.Create<System.Object, System.Int32>(Url.RouteUrl(CandidateRouteNames.MyApplications)
