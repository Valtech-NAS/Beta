...
namespace SFA.Apprenticeships.Web.Candidate.Views.ApprenticeshipSearch
{
    ...
    var locationTypeLink = Model.VacancySearch.LocationType == ApprenticeshipLocationType.National ? Url.Action("results", new ApprenticeshipSearchViewModel(Model.VacancySearch) { LocationType = ApprenticeshipLocationType.NonNational, SearchAction = SearchAction.Sort, PageNumber = 1 }) : Url.Action("results", new ApprenticeshipSearchViewModel(Model.VacancySearch) { LocationType = ApprenticeshipLocationType.National, SearchAction = SearchAction.Sort, SortType = VacancySortType.Distance, PageNumber = 1 });
...
WriteAttribute("content", Tuple.Create(" content=\"", 3527), Tuple.Create("\"", 3558)
            
            #line 81 "..\..\Views\ApprenticeshipSearch\Results.cshtml"
, Tuple.Create(Tuple.Create("", 3537), Tuple.Create<System.Object, System.Int32>(Model.TotalLocalHits
