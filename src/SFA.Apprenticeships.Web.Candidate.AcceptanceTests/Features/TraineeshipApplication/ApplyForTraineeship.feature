...
@US687
Scenario: As a candidate applying for a traineeship I want to know that I have to add when recording qualifications
	Given I have registered a new candidate
	When I select the "first" traineeship vacancy in location "N7 8LS" that can apply by this website
	Then I am on the TraineeshipDetailsPage page
	When I choose ApplyButton
...
Given I have registered a new candidate
	...
	And I am on the TraineeshipApplicationPage page
	And I choose SaveQualification
	And I wait for 3 seconds to see QualificationsSummary
	Then I see
		| Field                    | Rule           | Value |
		| QualificationSaveWarning | Does Not Exist |       |
