namespace SFA.Apprenticeships.Web.Candidate.UnitTests.Helpers
{
    ...
    public class FormTextForTests : BaseExtensionTests
    {
        ...
        public void TestFormTextForRendersPropertyNameWhenNoDisplayNameAssigned()
        {
            ...
            // Assert
            Assert.AreEqual("<div class=\"form-group\"><a href=\"#value\"></a><label class=\"form-label\" for=\"Value\">Value</label><input class=\"form-control\" id=\"Value\" name=\"Value\" type=\"text\" value=\"\" /></div>", s.ToString());
        }
        ...
        public void TestFormTextForRendersDisplayNameAndHintText()
        {
            ...
            // Assert
            Assert.AreEqual(
                "<div class=\"form-group\"><a href=\"#hasattribute\"></a><label class=\"form-label\" for=\"HasAttribute\">Keywords</label><span class=\"form-hint\">For example</span><input class=\"form-control\" id=\"HasAttribute\" name=\"HasAttribute\" type=\"text\" value=\"\" /></div>",
                s.ToString());
        }
