namespace SFA.Apprenticeships.Infrastructure.Monitor.MessageLossCheck.Repository
{
    ...
    public class ApprenticeshipApplicationDiagnosticsRepository : GenericMongoClient<MongoApplicationDetail>, IApprenticeshipApplicationDiagnosticsRepository
    {
        ...
        public IEnumerable<ApplicationDetail> GetApplicationsForValidCandidatesWithUnsetLegacyId()
        {
            var applicationsForValidCandidatesWithUnsetLegacyId = new List<ApplicationDetail>();
            ...
            foreach (var mongoApprenticeshipApplicationDetail in applicationWithUnsetLegacyId)
            {
                ...
                var apprenticeshipApplicationDetail = _mapper.Map<MongoApplicationDetail, ApplicationDetail>(mongoApprenticeshipApplicationDetail);
