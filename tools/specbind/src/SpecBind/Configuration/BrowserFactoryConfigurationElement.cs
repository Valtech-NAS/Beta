...
namespace SpecBind.Configuration
{
	...
	public class BrowserFactoryConfigurationElement : ConfigurationElement
	{
        ...
        private const string DriverNeedsValidationElementName = "driverNeedsValidation";
        ...
        [ConfigurationProperty(DriverNeedsValidationElementName, DefaultValue = false, IsRequired = false)]
        public bool DriverNeedsValidation
        {
            get
            {
                return (bool)this[DriverNeedsValidationElementName];
            }

            set
            {
                this[DriverNeedsValidationElementName] = value;
            }
        }
