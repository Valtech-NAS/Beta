namespace SFA.Apprenticeships.Web.Employer.Framework
{
    ...
    public static class HtmlExtensions
    {
        ...
        public static MvcHtmlString FormLabelFor<TModel, TProperty>(
                    this HtmlHelper<TModel> helper,
                    Expression<Func<TModel, TProperty>> expression,
                    string labelText = null,
                    string hintText = null,
                    ...
                    )
        {
            ...
            return BuildLabelControl(helper,
                                    expression,
                                    labelText,
                                    hintText,
                                    labelHtmlAttributes,
        ...
        private static MvcHtmlString BuildLabelControl<TModel, TProperty>(
